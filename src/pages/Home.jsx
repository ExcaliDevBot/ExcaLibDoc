            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-6">
                  Setting up a swerve drive has never been easier. Define your module configuration, 
                  create your swerve drive, and you're ready to go. Our library handles the complex 
                  kinematics and odometry calculations behind the scenes.
                </p>
                <Link
                  to="/docs/swerve"
              ...
              <div>
                <CodeBlock language="java" title="Robot.java">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <svg className="h-12 w-12 text-secondary-400 mb-4" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-slate-300 max-w-2xl mx-auto mb-10">
              Get started with our library today and build a championship-level robot for your next competition.
            </p>
