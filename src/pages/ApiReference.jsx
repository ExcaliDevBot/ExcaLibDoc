        ...
        <div className="max-w-6xl mx-auto py-8 px-4">
            ...
            <div className="space-y-6">
                                ...
                                {cls.values && cls.values.length > 0 && (
                                    <div className="mb-6">
                                        ...
                                        <ul className="pl-6 space-y-2">
                                            {cls.values.map((value, index) => (
                                                <li key={index} className="text-slate-700 dark:text-slate-300">
                                                    <span
                                                        className="font-mono text-secondary-600 dark:text-secondary-400">{value.name}</span> - {value.description}
                                                </li>
                                            ))}
                                        </ul>
                                    </div>
                                                            ...
                                                            <ul className="pl-6 space-y-2">
                                                                {method.parameters.map((param, paramIndex) => (
                                                                    <li key={paramIndex}
                                                                        ...
                                                                        <span
                                                                            className="font-mono text-secondary-600 dark:text-secondary-400">{param.name}</span>
                                                                        <span
                                                                            className="text-slate-500 dark:text-slate-400"> ({param.type})</span> - {param.description}
                                                                    </li>
                                                                ))}
                                                            </ul>
                                                        </div>
                                                    ...
                                                    {method.returns && (
                                                        <div>
                                                            ...
                                                            <p className="pl-6 text-slate-700 dark:text-slate-300">
                                                                <span
                                                                    className="text-slate-500 dark:text-slate-400">({method.returns.type})</span> - {method.returns.description}
                                                            </p>
                                                        </div>
                                                    )}
                                                </div>
                ...
                {filteredClasses.length === 0 && (
                    <div
                        className="bg-white dark:bg-slate-800 rounded-lg shadow border border-slate-200 dark:border-slate-700 p-8 text-center">
