    ...
    methods: [
        {
            ...
            parameters: [
                {name: "motor", type: "Motor", description: "The motor controller for the arm."},
                {
                    name: "angleSupplier",
                    type: "DoubleSupplier",
                    description: "Supplies the current angle of the arm in radians."
                },
        ...
        },
        {
            ...
            parameters: [
                {
                    name: "setpointSupplier",
                    type: "DoubleSupplier",
                    description: "Supplies the target angle setpoint (radians)."
                },
                {
                    name: "toleranceConsumer",
                    type: "Consumer<Boolean>",
                    description: "Receives whether the arm is within the specified tolerance."
                },
