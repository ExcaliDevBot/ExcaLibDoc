    ...
    methods: [
        {
            ...
            parameters: [
                {name: 'rampRate', type: 'double', description: 'The rate at which the voltage ramps up, in volts per second.'},
                {name: 'stepVoltage', type: 'double', description: 'The step voltage to apply during the system identification routine, in volts.'},
                {name: 'timeOut', type: 'double', description: 'The timeout duration for the system identification routine, in seconds.'}
            ],
