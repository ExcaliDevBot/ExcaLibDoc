export const flexMotorApi = {
    ...
    methods: [
        {
            name: 'FlexMotor',
            signature: 'public FlexMotor(int deviceId, MotorType type)',
            description: 'Constructs a new FlexMotor instance with the specified device ID and motor type.',
            parameters: [
                {name: 'deviceId', type: 'int', description: 'The CAN device ID of the Spark Flex motor controller.'},
                {name: 'type', type: 'MotorType', description: 'The type of motor.'}
            ],
            returns: {type: 'FlexMotor', description: 'A new FlexMotor instance.'}
        },
        {
            name: 'stopMotor',
