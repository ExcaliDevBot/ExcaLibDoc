...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden lg:block w-64 fixed top-16 left-0 h-[calc(100vh-4rem)] bg-white dark:bg-slate-800 shadow-md z-40 border-r border-slate-200 dark:border-slate-700 overflow-y-auto">
        <SidebarContent
